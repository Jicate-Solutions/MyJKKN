...
export function DigitalResourceForm({
  ...
  const getDefaultValues: () => FormValues = () => {
    ...
    return {
      ...
      license_information: {
        ...
        usage_constraints:
          initialData.license_information?.usage_constraints || []
      },
      ...
      access_availability: {
        time_restrictions:
          initialData.access_availability?.time_restrictions || [],
        concurrency_limits:
          initialData.access_availability?.concurrency_limits || 1
      },
      sharing_restrictions: initialData.sharing_restrictions || [],
      maintenance_schedule: {
        last_update: initialData.maintenance_schedule?.last_update || '',
        next_scheduled_update:
          initialData.maintenance_schedule?.next_scheduled_update || ''
      },
    ...
    const fetchInstitutions = async () => {
      try {
        ...
        setInstitutionsError(
          (error as any)?.message || 'Failed to load institutions'
        );
  ...
  useEffect(() => {
    ...
    const fetchDepartments = async () => {
      try {
        ...
        setDepartmentsError(
          (error as any)?.message || 'Failed to load departments'
        );
        // Don't show toast for expected errors when tables don't exist yet
        if (!(error as any)?.message?.includes('does not exist')) {
  ...
  const addUsageConstraint = () => {
    ...
    const currentConstraints =
      form.getValues('license_information.usage_constraints') || [];
    form.setValue('license_information.usage_constraints', [
      ...currentConstraints,
      usageConstraint.trim()
    ]);
    setUsageConstraint('');
  };
  ...
  const addTimeRestriction = () => {
    ...
    const currentRestrictions =
      form.getValues('access_availability.time_restrictions') || [];
    form.setValue('access_availability.time_restrictions', [
      ...currentRestrictions,
      timeRestriction.trim()
    ]);
    setTimeRestriction('');
  };
  ...
  const addSharingRestriction = () => {
    ...
    form.setValue('sharing_restrictions', [
      ...currentRestrictions,
      sharingRestriction.trim()
    ]);
          ...
          <CardContent className='space-y-6'>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>When the license expires</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-2'>
                {form
                  .watch('license_information.usage_constraints')
        ...
        <Card>
          ...
          <CardContent className='space-y-6'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Maximum number of users who can access the resource
                    simultaneously
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-2'>
                {form
                  .watch('access_availability.time_restrictions')
