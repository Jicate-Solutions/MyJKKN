...
function DashboardCard({
  ...
  return (
    ...
    >
      <Card className={cn("relative overflow-hidden hover:shadow-lg dark:hover:shadow-2xl transition-all duration-300 dark:bg-gray-800 dark:border-gray-700", className)}>
  ...
  const dashboardCards = [
    {
      ...
      badge: attendanceData.percentage >= 75
    ...
    },
    {
      ...
      icon: CreditCard,
      badge: billingData.pendingAmount === 0
  ...
  return (
    <div className="px-4 py-6">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-300">Welcome back! Here's your academic summary</p>
      </motion.div>
