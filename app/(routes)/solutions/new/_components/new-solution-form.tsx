...
import { Hammer, BookOpen, Video, Loader2, AlertCircle, Users, FlaskConical, ClipboardCheck } from 'lucide-react';
...
const typeOptions = [
  ...
  },
  {
    value: 'consulting',
    label: 'Consulting',
    description: 'Advisory, strategy, process improvement',
    icon: Users,
  ...
  },
  {
    value: 'research',
    label: 'Research',
    description: 'Studies, papers, R&D projects',
    icon: FlaskConical,
    color: 'text-teal-600',
  },
  {
    value: 'audit',
    label: 'Audit',
    description: 'Compliance, quality, accreditation audits',
    icon: ClipboardCheck,
    color: 'text-rose-600',
  },
];
