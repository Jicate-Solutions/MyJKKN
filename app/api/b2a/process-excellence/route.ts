/**
 * B2A — Process excellence (audit attestations) read-only list.
 * GET /api/b2a/process-excellence
 */
...
const MODULE_KEY = 'process-excellence' as const;
const TABLE_NAME = 'audit_attestations';
const ENDPOINT = '/api/b2a/process-excellence';
