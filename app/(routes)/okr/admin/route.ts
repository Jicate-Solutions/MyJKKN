...
/**
 * /okr/admin — answers with a REAL HTTP 307 to /okr/admin/compliance.
 *
 * Was a page.tsx calling `redirect('/okr/admin/compliance')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/okr/admin/compliance">`:
 ...
 * `<Link href="/okr/admin">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/okr/admin/compliance', request.url), 307);
}
