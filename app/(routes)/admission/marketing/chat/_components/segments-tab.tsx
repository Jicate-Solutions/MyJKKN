...
function SegmentBuilderDialog({ open, onOpenChange, institutionId, editingSegment }: SegmentBuilderProps) {
  ...
  const { preview, data: previewData, isLoading: previewing, reset: resetPreview } = useWASegmentPreview();
...
// =============================================================================
// SEGMENTS TAB (embedded in WhatsApp Command Center)
// =============================================================================

function SegmentsTabContent({ institutionId }: { institutionId: string }) {
  const { segments, isLoading: segmentsLoading, refetch } = useWASegments(institutionId || undefined);
...
export function SegmentsTab({ institutionId }: { institutionId: string }) {
  return (
    <AdmissionErrorBoundary>
      <SegmentsTabContent institutionId={institutionId} />
    </AdmissionErrorBoundary>
  );
}
