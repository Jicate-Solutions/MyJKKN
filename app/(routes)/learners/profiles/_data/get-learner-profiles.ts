...
// Only the relations `_components/columns.tsx` actually renders. The detail
// page, the promotion form and the export dialog each fetch through their OWN
// code paths, so the degree / department / academic_year / regulation / batch
// embeds this list query used to carry were hydrated for every row and read by
// nobody.
const LIST_SELECT = `
  *,
 ...
 * filter silently stops applying to one of them.
 */
