// app/api/cron/orchestration-run-ai/hr/route.ts
//
// GET /api/cron/orchestration-run-ai/hr
...
// "orchestration-run-ai-hr" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'hr');
}
