                  ...
                  {assignments.map((assignment) => {
                    ...
                    return (
                      <TableRow key={assignment.id}>
                        ...
                        <TableCell>{assignment.phase?.solution?.client?.name || '-'}</TableCell>
                        <TableCell>
                        ...
                        <TableCell className="text-right">{formatCurrency(assignment.phase?.estimated_value)}</TableCell>
                      </TableRow>
                    );
                  })}
                </TableBody>
