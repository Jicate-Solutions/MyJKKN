/**
 * Alumni Search Wrapper Component
 *
...
interface AlumniSearchWrapperProps {
  statusFilter?: 'graduated' | 'alumni';
}

export function AlumniSearchWrapper({ statusFilter }: AlumniSearchWrapperProps) {
  ...
  return (
    <LearnerAdvancedSearchShared
      ...
      onClear={handleClear}
      showApplicationId={false} // Alumni don't have application_id
    />
  );
}
