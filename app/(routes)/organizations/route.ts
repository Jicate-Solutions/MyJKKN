...
/**
 * /organizations — answers with a REAL HTTP 307 to /organizations/dashboard.
 *
 * Was a page.tsx calling `redirect('/organizations/dashboard')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/organizations/dashboard">`:
 ...
 * `<Link href="/organizations">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/organizations/dashboard', request.url), 307);
}
