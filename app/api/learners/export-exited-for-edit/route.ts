...
export async function GET(request: NextRequest) {
  try {
    ...
    const excelData = learners.map(learner => ({
      ...
      'Institution ID': learner.institution_id || '',
      'Degree ID': learner.degree_id || '',
      'Department ID': learner.department_id || '',
      'Department Name': learner.department?.department_name || '',
      'Program ID': learner.program_id || '',
      'Program Name': learner.program?.program_name || '',
      'Semester ID': learner.semester_id || '',
      'Semester Name': learner.semester?.semester_name || '',
      'Section ID': learner.section_id || '',
      'Section Name': learner.section?.section_name || '',
      'Academic Year ID': learner.academic_year_id || '',
      'Regulation ID': learner.regulation_id || '',
      'Batch ID': learner.batch_id || '',
    ...
    const instructions = [
      ...
      { 'A': '• Institution ID, Degree ID, Department ID' },
      { 'A': '• Program ID, Semester ID, Section ID' },
      { 'A': '• Academic Year ID, Regulation ID, Batch ID' },
      { 'A': '' },
