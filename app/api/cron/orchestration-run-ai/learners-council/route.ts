// app/api/cron/orchestration-run-ai/learners-council/route.ts
//
// GET /api/cron/orchestration-run-ai/learners-council
...
// "orchestration-run-ai-learners-council" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'learners-council');
}
