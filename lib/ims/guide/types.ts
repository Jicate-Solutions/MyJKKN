...
/* ────────────────────────────────────────────────────────────────────────
 * 1. PERSONAS — IMS (Inventory Management System) operational lanes.
 *    Split mirrors the real route→permission guards in lib/sidebarMenuLink.ts:
 *    a requester who raises indents, an approver who clears them, a
 *    store-keeper who runs inventory + stock + GRN, a cashier who runs POS
 *    sales, and an admin who owns settings, suppliers, reports and audit.
 * ──────────────────────────────────────────────────────────────────────── */
