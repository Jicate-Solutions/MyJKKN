...
/**
 * /ims/inventory — answers with a REAL HTTP 307 to /ims/inventory/items.
 *
 * Was a page.tsx calling `redirect('/ims/inventory/items')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/ims/inventory/items">`:
 ...
 * `<Link href="/ims/inventory">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/ims/inventory/items', request.url), 307);
}
