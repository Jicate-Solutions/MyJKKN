    ...
    return (
      <div className='p-4'>
        <Alert variant='destructive'>
          ...
          <AlertDescription>
            You don&apos;t have permission to view employees categories.
          </AlertDescription>
        </Alert>
      </div>
    );
  ...
  return (
    <div className='space-y-6 mt-4'>
      <div className='flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-start'>
        <div>
          <h1 className='text-2xl font-bold py-1'>Employees Categories</h1>
          <p className='text-sm sm:text-base text-muted-foreground'>
            Manage employment categories for employees
          </p>
        </div>
