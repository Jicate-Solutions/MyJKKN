              ...
              <TableBody>
                {builders.length === 0 ? (
                  ...
                  builders.map((builder) => (
                    <TableRow key={builder.id} className="cursor-pointer hover:bg-muted/50" onClick={() => router.push(`/solutions/builders/${builder.id}`)}>
                      <TableCell>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <Link href={`/solutions/builders/${builder.id}`} className="font-medium hover:underline" onClick={(e) => e.stopPropagation()}>
                              {builder.name}
                            </Link>
