...
/**
 * /learner — answers with a REAL HTTP 307 to /learner/idp.
 *
 * Was a page.tsx calling `redirect('/learner/idp')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/learner/idp">`:
 ...
 * `<Link href="/learner">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/learner/idp', request.url), 307);
}
