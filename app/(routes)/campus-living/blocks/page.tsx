      ...
      <div className="space-y-6 mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredBlocks.map((block: any) => {
            const totalCapacity = block.total_capacity ?? 0;
            const currentOccupancy = block.current_occupancy ?? 0;
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">{currentOccupancy}/{totalCapacity} ({occupancyPercent}%)</span>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-3 text-center">
                      <div>
                        <p className="text-lg font-semibold">{block.total_floors ?? 0}</p>
                        <p className="text-xs text-muted-foreground">Floors</p>
                      </div>
                      <div>
                        <p className="text-lg font-semibold">{block.total_rooms ?? 0}</p>
                        <p className="text-xs text-muted-foreground">Rooms</p>
                      </div>
                      <div>
                        <p className="text-lg font-semibold">{totalCapacity - currentOccupancy}</p>
