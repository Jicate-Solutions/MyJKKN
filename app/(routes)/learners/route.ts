...
/**
 * /learners — answers with a REAL HTTP 307 to /learners/profiles.
 *
 * Was a page.tsx calling `redirect('/learners/profiles')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/learners/profiles">`:
 ...
 * `<Link href="/learners">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/learners/profiles', request.url), 307);
}
