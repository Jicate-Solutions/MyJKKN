...
-- Verbatim copy of supabase/migrations/20270307090000_ai_rpc_scope_parameter_guards.sql
-- from draft PR #3983 (head 63d1628d9c19), the reference for what a guarded
-- institution-id lookup looks like. The gate MUST pass it.
