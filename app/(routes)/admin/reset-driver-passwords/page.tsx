...
export default function ResetDriverPasswordsPage() {
  ...
  const handleReset = async () => {
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : 'Failed to reset passwords'
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className='max-w-4xl mx-auto space-y-6'>
        <Card>
          ...
          <CardContent className='space-y-4'>
            <Alert>
              ...
              <AlertDescription>
                This will reset all driver user passwords to:{' '}
                <strong>Driver@123</strong>
                <br />
        ...
        <Card>
          ...
          <CardContent>
            <div className='space-y-2'>
              <p>
                <strong>Email:</strong> [driver&apos;s email address]
              </p>
              <p>
                <strong>Password:</strong> Driver@123
              </p>
              <p className='text-sm text-muted-foreground mt-3'>
                Note: Users should change their password after first login for
                security.
              </p>
            </div>
          </CardContent>
