...
/**
 * /admin/hr/payroll/periods — payroll period list page (T4.3 PR 3).
 *
...
function PayrollPeriodsListContent() {
  ...
  const updateFilter = (key: 'institution_id' | 'status', value: string) => {
    ...
    router.replace(`/admin/hr/payroll/periods?${params.toString()}`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Button asChild>
          <Link href="/admin/hr/payroll/periods/new">
