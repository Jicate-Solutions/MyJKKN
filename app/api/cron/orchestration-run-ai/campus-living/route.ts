// app/api/cron/orchestration-run-ai/campus-living/route.ts
//
// GET /api/cron/orchestration-run-ai/campus-living
...
// "orchestration-run-ai-campus-living" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'campus-living');
}
