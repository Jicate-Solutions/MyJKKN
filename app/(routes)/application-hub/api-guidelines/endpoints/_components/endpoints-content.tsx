  ...
  return (
    <div className='py-4 space-y-6'>
      ...
      <Accordion type='single' collapsible className='space-y-4'>
        {/* Learners Endpoints */}
        <AccordionItem value='learners' className='border rounded-lg'>
          <AccordionTrigger className='px-4 hover:no-underline'>
            <div className='flex items-center gap-2'>
              <span className='font-semibold'>Learners API</span>
              <Badge variant='secondary'>GET</Badge>
            </div>
          </AccordionTrigger>
          <AccordionContent className='px-4 pb-4 space-y-6'>
            <div className='space-y-4'>
              <h3 className='text-lg font-semibold'>List Learner Profiles</h3>
              <CodeBlock
                language='bash'
                code={`GET /api-management/learners/profiles`}
              />
              <div className='space-y-2'>
                ...
                <ul className='list-disc list-inside space-y-1 text-sm'>
                  ...
                  <li>
                    <code className='bg-muted px-1'>lifecycle_status</code>:
                    Comma-separated statuses, or <code>all</code> (default:
                    active only)
                  </li>
                  <li>
                  ...
                  <li>
                    <code className='bg-muted px-1'>semester_id</code>: Filter
                    by semester
                  </li>
                  <li>
                    <code className='bg-muted px-1'>section_id</code>: Filter by
                    section
                  </li>
                  <li>
                    <code className='bg-muted px-1'>expand</code>: Comma-separated
                    related data to include (e.g. program,semester,section)
                  </li>
                </ul>
              </div>

              <h3 className='text-lg font-semibold'>Get Learner Profile by ID</h3>
              <CodeBlock
                language='bash'
                code={`GET /api-management/learners/profiles/{id}`}
              />
            </div>
          </AccordionContent>
        </AccordionItem>
