...
import { type PersonaGuide, type GuideEvent, type GuidePersona, laneProgress } from "@/lib/campus-living/guide/types"; // ← adjust path
import { useGuideProgress } from "@/lib/campus-living/guide/use-progress"; // ← adjust path
import { GuideDrawer } from "@/components/campus-living/guide/guide-drawer"; // ← adjust path
