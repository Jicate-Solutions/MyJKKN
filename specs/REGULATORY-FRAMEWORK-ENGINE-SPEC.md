...
| GET | `/api/regulatory/submissions/[id]` | `getSubmissionById(id)` | super_admin, institution_admin, iqac_coordinator, principal, hod | Submission detail with scores (hod: read-only, sensitive fields stripped) |
