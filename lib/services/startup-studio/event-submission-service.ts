  ...
  static async createSubmission(dto: SubmitProjectDto, userId: string): Promise<EventSubmission> {
    ...
    const { data, error } = await this.supabase
      ...
      .insert({
        ...
        solution_summary: dto.solution_summary,
        elevator_pitch: dto.elevator_pitch || null,
        github_url: dto.github_url,
        live_app_url: dto.live_app_url || null,
        lovable_url: dto.lovable_url || null,
        demo_video_url: dto.demo_video_url || null,
  ...
  static async updateSubmission(submissionId: string, dto: Partial<SubmitProjectDto>): Promise<EventSubmission> {
    ...
    const { data, error } = await this.supabase
      ...
      .update({
        ...
        ...(dto.problem_statement !== undefined && { problem_statement: dto.problem_statement }),
        ...(dto.solution_summary !== undefined && { solution_summary: dto.solution_summary }),
        ...(dto.elevator_pitch !== undefined && { elevator_pitch: dto.elevator_pitch || null }),
        ...(dto.github_url !== undefined && { github_url: dto.github_url }),
        ...(dto.live_app_url !== undefined && { live_app_url: dto.live_app_url || null }),
        ...(dto.lovable_url !== undefined && { lovable_url: dto.lovable_url || null }),
        ...(dto.demo_video_url !== undefined && { demo_video_url: dto.demo_video_url || null }),
