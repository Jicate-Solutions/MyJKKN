      ...
      <ContentLayout title='Category Details'>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink asChild>
                <Link href='/digital-resources/categories'>Categories</Link>
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
      ...
      <ContentLayout title='Category Details'>
        ...
        <div className='text-center py-8'>
          ...
          <Button variant='outline' asChild>
            <Link href='/digital-resources/categories'>Back to Categories</Link>
          </Button>
        </div>
      </ContentLayout>
    );
      ...
      <div className='space-y-6 mt-4'>
        <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4'>
          ...
          <div className='flex space-x-2'>
            <Link href={`/digital-resources/categories/${category.id}/edit`}>
          ...
          <CardContent className='space-y-6'>
            ...
            <div>
              <div className='flex justify-between items-center mb-4'>
                ...
                <Link href={`/digital-resources/new?category_id=${category.id}`}>
