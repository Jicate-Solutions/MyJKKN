...
/* ────────────────────────────────────────────────────────────────────────
 * 1. PERSONAS — Board of Studies (BoS) lanes. Four real human roles drawn
 *    from the BoS access model (lib/utils/bos/bos-access.ts):
 *      - coordinator: super-admin / academic-office that sets up master data
 *        and reports (granular academic.bos-* keys).
 *      - chairman: the HOD who chairs a board composition (schedules meetings,
 *        edits the composition, approves syllabi, manages members).
 *      - member: faculty / external expert who sits on a board (views, builds
 *        the syllabus and outcomes, submits TA/DA).
 *      - principal: read-only "governor" who approves meeting/syllabus status
 *        but cannot edit field data.
 * ──────────────────────────────────────────────────────────────────────── */
