...
import { Clock, BookOpen, GraduationCap, Wallet, Award, ArrowRight, ShieldOff, Info } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden border-amber-200/60">
        <div className="bg-gradient-to-br from-amber-500 via-amber-400 to-yellow-400 p-6 sm:p-8">
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <Award className="h-6 w-6 text-white/90" />
                <Badge className="bg-white/20 text-white border-white/30 hover:bg-white/30">
                  {privilege.group_status === 'active' ? 'Active' : privilege.group_status}
                </Badge>
              </div>
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1 text-sm text-muted-foreground">
              ...
              <p>Reviewed each semester — continued performance expected</p>
            </div>
            <Link
