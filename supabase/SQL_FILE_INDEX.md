...
- Config: 8 `platform_policies` rows `copo_attainment.*` — master_enabled=false (DARK), threshold_pct=60, direct_weight=0.8, indirect_weight=0.2, target_level=2, level bands 70/60/50 — every description flags 'DEFAULT — Director/Academic Council must ratify before go-live'.
