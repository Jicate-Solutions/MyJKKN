...
/**
 * Schema for validating the search parameters for the degrees table.
 */
export const degreesSearchParamsSchema = z.object({
...
export type DegreesSearchParams = z.infer<typeof degreesSearchParamsSchema>;
