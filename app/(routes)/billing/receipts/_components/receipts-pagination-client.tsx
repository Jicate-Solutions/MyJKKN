/**
 * Receipts Pagination Client Component
 *
 * URL-based pagination for receipt list page.
...
interface ReceiptsPaginationClientProps {
  totalPages: number;
  currentPage: number;
  totalItems: number;
}

export function ReceiptsPaginationClient({
  totalPages,
  currentPage,
  totalItems
}: ReceiptsPaginationClientProps) {
