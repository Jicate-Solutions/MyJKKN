...
/**
 * Schema for validating the search parameters for the departments table.
 */
export const departmentsSearchParamsSchema = z.object({
  ...
  // Custom filters for departments
...
export type DepartmentsSearchParams = z.infer<typeof departmentsSearchParamsSchema>;