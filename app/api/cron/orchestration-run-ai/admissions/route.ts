// app/api/cron/orchestration-run-ai/admissions/route.ts
//
// GET /api/cron/orchestration-run-ai/admissions
...
// "orchestration-run-ai-admissions" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'admissions');
}
