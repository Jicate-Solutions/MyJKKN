      ...
      <div className="space-y-6 mt-4">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-start">
          ...
          <Button asChild className="bg-[#0b6d41] hover:bg-[#0b6d41]/90">
            <Link href="/faculty/pde/cases/new">
                  ...
                  {filtered.map((c: ClinicalCase) => (
                    <TableRow key={c.id}>
                      <TableCell className="font-medium">
                        <Link href={`/faculty/pde/cases/${c.id}/edit`} className="hover:underline">
                          {c.title}
                        </Link>
                        {c.description ? (
                      ...
                      <TableCell className="text-right space-x-2">
                        <Button asChild variant="ghost" size="sm">
                          <Link href={`/faculty/pde/cases/${c.id}/edit`}>Edit</Link>
                        </Button>
                        <Button asChild variant="ghost" size="sm">
                          <Link href={`/faculty/pde/cases/${c.id}/preview`}>Preview</Link>
                        </Button>
                        {c.status === 'published' ? (
                          <Button asChild variant="ghost" size="sm">
                            <Link href={`/faculty/pde/cases/${c.id}/attempts`}>Cohort</Link>
                          </Button>
                        ) : null}
                      </TableCell>
                    </TableRow>
