...
export const GUIDE_PERSONAS: readonly GuidePersona[] = [
  // Order = default priority: most-specific first. A student-role learner is
  // pinned to "learner" by the page regardless of any stray staff key. The
  // learner lane has NO `requires` (universal instructional baseline, like
  // campus-living's resident lane); faculty + admin are permission-gated.
  "admin",
  "faculty",
  "learner",
] as const;
