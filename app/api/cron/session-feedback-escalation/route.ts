...
function escalationTemplate(e: Escalation): string {
  ...
  return `Average understanding ${avg}/5 across ${e.responses} learners — below the escalation threshold. Review recent ${e.course_name || e.course_code} sessions and pace/clarity with the teacher.`;
}
