...
/**
 * /academic — answers with a REAL HTTP 307 to /academic/years.
 *
 * Was a page.tsx calling `redirect('/academic/years')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/academic/years">`:
 ...
 * `<Link href="/academic">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/academic/years', request.url), 307);
}
