...
/* ────────────────────────────────────────────────────────────────────────
 * 1. PERSONAS — Organizations module lanes.
 *    The academic org hierarchy (institutions → departments → programs/
 *    degrees → courses → sections/semesters) is built by a registry admin and
 *    read by everyone else. Two honest lanes: the builder and the viewer.
 * ──────────────────────────────────────────────────────────────────────── */
