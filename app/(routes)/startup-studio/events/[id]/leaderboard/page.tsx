...
export default function LeaderboardPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const isAdmin = profile?.role === 'admin' || profile?.role === 'administrator' || (profile as any)?.is_super_admin;
      ...
      <ContentLayout>
        ...
        <Card className="max-w-lg mx-auto mt-8">
          <CardContent className="pt-6 text-center space-y-3">
            ...
            <p className="text-muted-foreground">Results coming soon! Check back after results are published.</p>
          </CardContent>
        </Card>
      </ContentLayout>
    );
