...
import { applyNoteToBooking } from '@/lib/services/meetings/meeting-note-followups';
...
// Parsing the follow-ups, choosing their owners and applying them once per note
