...
import { DataTableRowActions, SyllabusPdfDownloadButton, SyllabusDocxDownloadButton, SyllabusHtmlDownloadButton, SyllabusCloneButton } from './row-actions';
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className='flex items-center gap-1'>
          ...
          <SyllabusHtmlDownloadButton syllabus={row.original} />
