...
### Archive cross-institution-pointer BoS syllabi — 4 rows (2026-07-27)
...
- HELD OUT by Director decision: 24UBAC12 (`a7615434`) — same defect shape, but its content was edited after its keeper; a human compares first (`.claude/bos-24ubac12-compare-2026-07-27.md`).
- Evidence: `.claude/bos-double-latest-finding-2026-07-26.md`. Remaining collisions are `course_id` import collisions — a different defect family, research ongoing.
