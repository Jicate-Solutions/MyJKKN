 ...
 * the learner self-view (`/learn/pde/transcript`) and admin view
 * (`/admin/pde/transcript/[learnerId]`).
 *
    ...
    <>
      ...
      <div className="pde-transcript">
        ...
        <div className="footer">
          ...
          transcript at <code>/learn/pde/transcript</code> with the learner&apos;s credentials.
        </div>
      </div>
    </>
  );
