...
export const GUIDE_PERSONAS: readonly GuidePersona[] = [
  // Order = default priority: most-specific first. An HR admin sees the
  // hr-admin lane; a manager who approves leave/recruitment sees the manager
  // lane; everyone else falls to the universal "employee" self-service lane.
  // The employee lane has NO `requires` (universal instructional baseline,
  // like pde's learner lane); manager + hr-admin are permission-gated.
  "hr-admin",
  "manager",
  "employee",
] as const;
