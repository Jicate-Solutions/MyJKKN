/**
 * /admin/pde/transcript/[learnerId] — Admin/super-admin view of any
...
import { TranscriptDocument } from '../../../../learn/pde/transcript/_components/TranscriptDocument';
...
export default async function AdminTranscriptPage({
  ...
  if (!user) {
    redirect(`/auth/login?next=/admin/pde/transcript/${learnerId}`);
  }
