...
-- /admin/pde/rubrics/embodied UI → behavior changes on next demonstration
...
INSERT INTO platform_policies (
  ...
  (
    ...
    'object',
    'PDE Phase 7 — Embodied Practice rubric for Medical (MBBS). Skills emphasize OSCE-style clinical demonstration: history-taking, physical exam, suturing, IV cannulation, BLS. Director-editable via /admin/pde/rubrics/embodied.',
    NULL,
    false,
    true
  ),
  (
    ...
    'object',
    'PDE Phase 7 — Embodied Practice rubric for Pharmacy (B.Pharm / Pharm.D). Skills emphasize prescription audit, compounding, drug-interaction reasoning, counselling, sterile handling. Director-editable via /admin/pde/rubrics/embodied.',
    NULL,
    false,
    true
  ),
  (
    ...
    'object',
    'PDE Phase 7 — Embodied Practice rubric for Nursing (B.Sc Nursing / GNM). Skills emphasize bedside procedures, wound care, IV therapy, patient handling, vitals, SBAR handover. Director-editable via /admin/pde/rubrics/embodied.',
    NULL,
    false,
    true
  ),
  (
    ...
    'object',
    'PDE Phase 7 — Embodied Practice rubric for Dental (BDS). Skills emphasize cavity prep, scaling, impressions, prosthetic fitting, dental-emergency OSCE. Director-editable via /admin/pde/rubrics/embodied.',
    NULL,
    false,
    true
  ),
  (
    ...
    'object',
    'PDE Phase 7 — Embodied Practice rubric for Engineering (B.E. / B.Tech). Skills emphasize lab demos, prototype builds, hardware debugging, safety adherence, peer review. Director-editable via /admin/pde/rubrics/embodied.',
    NULL,
    false,
    true
  )
