-- Fix attendance records with mismatched timetable period IDs
...
BEGIN
    ...
    timetable_periods AS (
        SELECT 
            ...
            st.full_name as tt_faculty_name
        FROM timetables t
...
-- Step 4: Create a validation function for attendance data integrity
