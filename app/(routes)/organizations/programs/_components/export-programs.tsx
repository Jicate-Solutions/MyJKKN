  ...
  const handleExport = async () => {
    try {
      ...
      const response = await fetch(
        `/api/organizations/programs/export?${params.toString()}`
      );
      ...
      if (contentDisposition) {
        ...
        filename = `programs-export-${dateStr}.${exportFormat}`;
      }
      ...
      toast.error(
        error instanceof Error ? error.message : 'Failed to export programs'
      );
    } finally {
