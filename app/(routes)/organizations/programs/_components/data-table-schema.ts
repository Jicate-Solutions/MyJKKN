...
/**
 * Schema for validating the search parameters for the programs table.
 */
export const programsSearchParamsSchema = z.object({
...
export type ProgramsSearchParams = z.infer<typeof programsSearchParamsSchema>;