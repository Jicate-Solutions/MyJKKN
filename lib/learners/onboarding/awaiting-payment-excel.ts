...
const DETAIL_COLUMNS: { header: string; key: string; width: number; fmt?: string }[] = [
  ...
  { header: 'Fees Due (as on date)', key: 'fees_due', width: 14, fmt: INR_FMT },
  { header: 'Due Paid', key: 'fees_paid', width: 14, fmt: INR_FMT },
  { header: 'Due Balance', key: 'fees_balance', width: 14, fmt: INR_FMT },
  { header: '% of Due Paid', key: 'pct_due', width: 11, fmt: PCT_FMT },
  { header: 'Need to Admit', key: 'need_to_admit', width: 14, fmt: INR_FMT },
