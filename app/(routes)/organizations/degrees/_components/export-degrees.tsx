...
export default function ExportDegrees() {
  ...
  const handleExport = async () => {
    try {
      ...
      const response = await fetch(
        `/api/organizations/degrees/export?${params.toString()}`,
        {
          method: 'GET',
          headers: {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || 'Failed to export degrees');
      }
      ...
      toast.error(
        error instanceof Error ? error.message : 'Failed to export degrees'
      );
    } finally {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Export Degrees</DialogTitle>
          <DialogDescription>
            Download degree data in your preferred format.
          </DialogDescription>
        </DialogHeader>
