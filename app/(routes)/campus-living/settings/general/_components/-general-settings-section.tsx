...
/**
 * GeneralSettingsSection — chrome-less editor body for campus-living general
 * settings.
 *
 * Extracted from `/campus-living/settings/general/page.tsx` (behavior-preserving
 * refactor) so the working editor can be embedded inside the unified Campus
 * Living config sections, which can't host a page that wraps its own
 * ContentLayout. The standalone page keeps its ContentLayout chrome and renders
 * this component in place of the former inline body.
 *
