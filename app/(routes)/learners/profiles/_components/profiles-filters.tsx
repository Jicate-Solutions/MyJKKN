  ...
  useEffect(() => {
    const fetchDegrees = async () => {
      ...
      try {
        ...
        console.error('[learners/profiles] Error fetching degrees:', error);
        setDegrees([]);
      } finally {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      ...
      try {
        ...
        console.error('[learners/profiles] Error fetching departments:', error);
        setDepartments([]);
      } finally {
  ...
  useEffect(() => {
    const fetchPrograms = async () => {
      ...
      try {
        ...
        console.error('[learners/profiles] Error fetching programs:', error);
        setPrograms([]);
      } finally {
  ...
  useEffect(() => {
    const fetchSemesters = async () => {
      ...
      try {
        ...
        console.error('[learners/profiles] Error fetching semesters:', error);
        setSemesters([]);
      } finally {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      ...
      try {
        ...
        console.error('[learners/profiles] Error fetching sections:', error);
        setSections([]);
      } finally {
  ...
  useEffect(() => {
    const fetchAcademicYears = async () => {
      ...
      try {
        ...
        console.error('[learners/profiles] Error fetching academic years:', error);
        setAcademicYears([]);
      } finally {
