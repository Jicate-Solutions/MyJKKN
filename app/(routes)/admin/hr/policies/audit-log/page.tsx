// =====================================================================
// /admin/hr/policies/audit-log — Wave 3 policy audit history viewer
// =====================================================================
      ...
      <CardContent className="py-12 text-center space-y-2">
        ...
        {hasFilters && (
          <Button asChild variant="outline" size="sm">
            <Link href="/admin/hr/policies/audit-log">Clear filters</Link>
          </Button>
        )}
      </CardContent>
    </Card>
    ...
    >
      ...
      <div className="md:col-span-4 flex gap-2 pt-1">
        ...
        <Button asChild type="button" variant="outline" size="sm">
          <Link href="/admin/hr/policies/audit-log">Reset</Link>
        </Button>
      </div>
    </form>
  );
