...
/**
 * /health — answers with a REAL HTTP 307 to /health/dashboard.
 *
 * Was a page.tsx calling `redirect('/health/dashboard')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/health/dashboard">`:
 ...
 * `<Link href="/health">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/health/dashboard', request.url), 307);
}
