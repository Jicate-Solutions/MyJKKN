...
const typeConfig: Record<SolutionType, { icon: React.ElementType; color: string; bg: string }> = {
  ...
  consulting: { icon: Users, color: 'text-amber-600', bg: 'bg-amber-100' },
  research: { icon: FlaskConical, color: 'text-teal-600', bg: 'bg-teal-100' },
  audit: { icon: ClipboardCheck, color: 'text-rose-600', bg: 'bg-rose-100' },
};
