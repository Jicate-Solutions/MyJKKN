...
/**
 * GET /api/analytics/usage/user-stats
 * Returns user statistics: login trends, role distribution, frequency, top users
 *
 * Query params:
...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await LifecycleDashboardService.getUserStats(
      {
        date_from: dateFrom,
        date_to: dateTo,
    ...
    console.error('[analytics/usage/user-stats] Error:', error);
    return NextResponse.json(
