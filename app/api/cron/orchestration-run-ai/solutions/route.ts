// app/api/cron/orchestration-run-ai/solutions/route.ts
//
// GET /api/cron/orchestration-run-ai/solutions
...
// "orchestration-run-ai-solutions" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'solutions');
}
