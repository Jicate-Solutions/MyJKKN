...
import { Hammer, BookOpen, Video, Users, FlaskConical, ClipboardCheck, Loader2 } from 'lucide-react';
...
const prospectFormSchema = z.object({
  ...
  solution_type_interest: z.enum(['software', 'training', 'content', 'consulting', 'research', 'audit']).optional(),
  solution_types_interest: z.array(z.enum(['software', 'training', 'content', 'consulting', 'research', 'audit'])).optional(),
...
const SOLUTION_OPTIONS: { value: SolutionType; label: string; description: string; icon: React.ElementType; color: string }[] = [
  ...
  { value: 'consulting', label: 'Consulting', description: 'Advisory, strategy, process improvement', icon: Users, color: 'text-amber-600 border-amber-200 bg-amber-50' },
  { value: 'research', label: 'Research', description: 'Studies, papers, R&D projects', icon: FlaskConical, color: 'text-teal-600 border-teal-200 bg-teal-50' },
  { value: 'audit', label: 'Audit', description: 'Compliance, quality, accreditation audits', icon: ClipboardCheck, color: 'text-rose-600 border-rose-200 bg-rose-50' },
];
