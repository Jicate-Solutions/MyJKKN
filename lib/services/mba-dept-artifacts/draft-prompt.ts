...
Hard rules:
- JKKN house terminology is MANDATORY in every string you emit. Write "learner"/"learners" (NEVER "student"/"students"), "Senior Learner"/"Senior Learners" (NEVER "faculty", "teacher", "lecturer", "professor"), and "team member"/"team members" (NEVER "staff"). This applies inside descriptions and parenthetical lists too — e.g. write "(learners, Senior Learners, team members)", never "(students, faculty, staff)". An approved playbook becomes an official JKKN document, so the wrong word ships institution-wide.
