...
1. Sign in as `test.superadmin@jkkn.ac.in` (`/auth/test-login`; password: the seeded test-account password (set `PERSONA_PASSWORD`, or ask the team password manager)).
