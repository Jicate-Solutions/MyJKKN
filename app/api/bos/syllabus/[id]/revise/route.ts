...
/**
 * POST /api/bos/syllabus/[id]/revise
 *
...
export async function POST(
  ...
  try {
    ...
    if (fetchError) {
      console.error('[POST /api/bos/syllabus/[id]/revise] Fetch error:', fetchError);
    ...
    if (updateOldError) {
      console.error('[POST /api/bos/syllabus/[id]/revise] Update old error:', updateOldError);
      return NextResponse.json(
    ...
    if (insertError) {
      console.error('[POST /api/bos/syllabus/[id]/revise] Insert error:', insertError);
    ...
    console.error('[POST /api/bos/syllabus/[id]/revise] Error:', error);
    return NextResponse.json(
