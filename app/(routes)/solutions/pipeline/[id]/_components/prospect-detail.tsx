...
const SOLUTION_CONFIG: Record<SolutionType, { icon: React.ElementType; label: string; color: string }> = {
  ...
  consulting: { icon: Users, label: 'Consulting', color: 'text-amber-600' },
  research: { icon: FlaskConical, label: 'Research', color: 'text-teal-600' },
  audit: { icon: ClipboardCheck, label: 'Audit', color: 'text-rose-600' },
};
