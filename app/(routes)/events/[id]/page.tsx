  ...
  return (
    <ContentLayout title={event.name}>
      ...
      <div className="mt-4 space-y-4">
        ...
        {/* Who is queuing for a full event, in order. Directly under the
            registration forms because it is the other half of that door: the
            forms are how people get in, this is what happens to the ones who
            arrived after the last place went. The card gates itself on
            fn_can_manage_event_waitlist and renders nothing at all when the
            event does not queue, when nobody is waiting, or when the viewer may
            not see a list of named people with their phone numbers. */}
