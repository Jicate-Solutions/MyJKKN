...
const metricDefinitions: MetricDefinition[] = [
  ...
  { criteria_code: 'ATTR-08', code: '8.4', name: 'Learning Experience Survey', description: 'Student and alumni satisfaction survey conducted by NAAC. 60 points. Student/alumni database shared with NAAC for independent survey.', scores: { university: 60, autonomous: 60, affiliated: 50 }, data_type: 'number', is_auto_calculable: false, requires_evidence: false, data_connector_code: null, sort_order: 5, evidence_type: 'external', metadata: { external_survey: true, conducted_by: 'NAAC' } },
