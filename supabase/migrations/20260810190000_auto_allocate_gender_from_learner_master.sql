-- ============================================================================
-- Campus Living — Auto-Allocate: resolve gender from the LEARNER MASTER record,
-- and stop reporting a missing gender as a missing room rule (2026-08-10)
-- ============================================================================
--
-- Full re-issue of 20260810160000 with the gender handling corrected. The
-- signature-cache body below is unchanged from that migration; only the gender
-- expressions and one exclusion_reason branch differ. Diff the two files.
--
