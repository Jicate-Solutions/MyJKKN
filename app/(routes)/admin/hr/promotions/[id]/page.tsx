...
/**
 * /admin/hr/promotions/[id] — detail / scoring screen (T5.2)
 *
 * Renders:
  ...
  if (error || !application) {
    return (
      <ContentLayout title="Promotion Application">
        ...
        <Button variant="outline" onClick={() => router.push('/admin/hr/promotions')}>
          Back to queue
        </Button>
      </ContentLayout>
    );
        ...
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href="/admin/hr/promotions">Promotion Queue</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
