// app/api/cron/orchestration-run-ai/notifications/route.ts
//
// GET /api/cron/orchestration-run-ai/notifications
...
// "orchestration-run-ai-notifications" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'notifications');
}
