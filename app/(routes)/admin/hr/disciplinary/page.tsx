// ============================================================================
// /admin/hr/disciplinary — Disciplinary case list (super_admin / HR Admin)
// ============================================================================
...
//   * "New case" button → /admin/hr/disciplinary/new.
// ============================================================================
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
        {VALID_STAGES.map((stage) => (
          <StatTile
            ...
            value={totals[stage]}
            href={`/admin/hr/disciplinary?stage=${stage}`}
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <Link
          href="/admin/hr/disciplinary/new"
            ...
            {cases.map((c) => (
              <tr key={c.id} className="border-t border-border">
                ...
                <td className="px-4 py-3 text-right">
                  <Link
                    href={`/admin/hr/disciplinary/${c.id}`}
                    className="text-primary underline-offset-4 hover:underline"
                  >
                    View
                  </Link>
