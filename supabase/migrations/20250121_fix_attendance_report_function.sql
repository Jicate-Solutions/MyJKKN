-- Fix get_attendance_report_list function syntax error
-- The issue was in the final RETURN QUERY EXECUTE statement where it was incorrectly concatenating the total_count
...
BEGIN
    ...
    -- Build final query with sorting and pagination - Fixed the syntax error here
