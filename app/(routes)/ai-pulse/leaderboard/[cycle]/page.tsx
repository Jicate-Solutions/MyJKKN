...
/**
 * AI Pulse — Leaderboard (thin redirect to existing event leaderboard surface).
 *
 ...
 * before forwarding to the existing `/startup-studio/events/[id]/leaderboard`
 ...
 */
export default async function AiPulseLeaderboardRedirect({ params }: Props) {
  ...
  redirect(`/startup-studio/events/${event.id}/leaderboard`);
}
