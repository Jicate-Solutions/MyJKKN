...
export default function DigitalSharingPoliciesPage() {
  ...
  useEffect(() => {
    if (pathname === '/resources/digital-resources/policies') {
      fetchPolicies();
    }
  }, [pathname, fetchPolicies]);
  ...
  const hasActiveFilters = () => {
    return !!(
      (filters.category_id && filters.category_id !== 'all_categories') ||
  ...
  return (
    <ContentLayout title='Digital Sharing Policies'>
      <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
      ...
      <div className='flex justify-between items-center mt-6'>
        <h1 className='text-2xl font-bold'>Digital Sharing Policies</h1>
        <Link href='/resources/digital-resources/policies/new'>
          <Button>
      ...
      <Card className='mt-6'>
        <CardHeader>
          <CardTitle>Digital Sharing Policies</CardTitle>
          <CardDescription>
          ...
          {loading ? (
            ...
            <div className='text-center py-8'>
              ...
              <h3 className='mt-4 text-lg font-medium'>
                No digital sharing policies found
              </h3>
              <p className='mt-2 text-sm text-muted-foreground'>
                {hasActiveFilters()
                  ? 'Try adjusting your filters or create a new policy'
                  : 'Get started by creating a new digital sharing policy'}
              </p>
              {hasActiveFilters() ? (
                <Button
                  variant='outline'
                  ...
                  <TableBody>
                    {policies.map((policy, index) => (
                      <TableRow key={policy.id}>
                        ...
                        <TableCell className='font-medium'>
                          <Link
                            href={`/resources/digital-resources/policies/${policy.id}`}
                        ...
                        <TableCell className='text-right'>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align='end'>
                              ...
                              <Link
                                href={`/resources/digital-resources/policies/${policy.id}/edit`}
                              >
                                <DropdownMenuItem>
