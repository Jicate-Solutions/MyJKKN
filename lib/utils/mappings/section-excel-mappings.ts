// lib/utils/mappings/section-excel-mappings.ts

/**
 * Excel Import/Export Mappings for Sections Module
 *
 * This file centralizes all dropdown value mappings between Excel and database for sections.
