...
export default function NewResourceRequestPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      // Create a direct Supabase client for submission
      const supabase = createClientSupabaseClient();

      try {
        console.log('Attempting direct insert with Supabase');
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <div className='relative'>
                                <span className='absolute font-semibold left-3 top-2'>
                                  ₹
                                </span>
                                <Input
                                  placeholder='0.00'
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Provide a clear justification for this resource
                            request
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
