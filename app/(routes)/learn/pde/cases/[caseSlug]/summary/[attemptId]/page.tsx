/**
 * /learn/pde/cases/[caseSlug]/summary/[attemptId] — Post-case review.
 *
...
export default async function SummaryPage({ params }: SummaryPageProps) {
  ...
  if (!user) {
    redirect(`/auth/login?next=/learn/pde/cases/${caseSlug}/summary/${attemptId}`);
  }
    ...
    <ContentLayout>
      <PageBreadcrumb
        items={[
          ...
          { label: assessment?.title ?? 'Case', href: `/learn/pde/cases/${caseSlug}` },
