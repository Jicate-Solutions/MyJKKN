...
/**
 * /system — answers with a REAL HTTP 307 to /system/api-management.
 *
 * Was a page.tsx calling `redirect('/system/api-management')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/system/api-management">`:
 ...
 * `<Link href="/system">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/system/api-management', request.url), 307);
}
