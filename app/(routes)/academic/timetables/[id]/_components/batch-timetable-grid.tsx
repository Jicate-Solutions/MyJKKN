...
import { DayOfWeek, Period, TimetableSlot } from '@/types/academics';
      ...
      return (
        ...
        >
          <div className='text-center'>
            <div className='text-gray-500 text-lg mb-2'>No periods configured</div>
        ...
        >
          <div className='min-w-full'>
            ...
            <div className='p-8 text-center'>
              <div className='text-gray-500 text-lg mb-2'>No dates selected</div>
              <div className='text-gray-400 text-sm'>
                    ...
                    >
                      {isBreakPeriod ? (
                        ...
                        <div
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            onSlotClick(dateRange.start, period, existingSlot);
                          }}
                        >
                          {existingSlot.is_break_slot ? (
                          ...
                          ) : existingSlot.is_combined && existingSlot.sub_slots ? (
                            <div className='text-purple-700 min-h-[60px] flex flex-col text-center'>
                              ...
                              <div className='flex-1 flex flex-col space-y-1'>
                                {existingSlot.sub_slots.map((subSlot, idx) => (
                                  <div
                            ...
                            <div className='text-blue-700 min-h-[50px] flex flex-col justify-center text-center'>
                              ...
                              {existingSlot.staff_members && existingSlot.staff_members.length > 0 && (
                                <div className='text-xs text-gray-700 mb-0.5 leading-tight'>
                                  {existingSlot.staff_members.slice(0, 1).map((staff, idx) => (
                                    <div key={idx} className='truncate text-xs'>
                                      {staff.first_name} {staff.last_name}
                                    </div>
                                  ))}
                                  {existingSlot.staff_members.length > 1 && (
                                    <div className='text-xs text-gray-500'>
                                      +{existingSlot.staff_members.length - 1} more
                                    </div>
                                  )}
                                </div>
                              )}
                              {existingSlot.sections && existingSlot.sections.length > 0 && (
                                <div className='text-xs'>
                                  {existingSlot.sections.slice(0, 2).map((section, idx) => (
                                    <Badge
