  ...
  const confirmBulkDelete = async () => {
    ...
    try {
      ...
      if (success.length > 0 && failed.length === 0) {
        toast.success(
          `${success.length} alumni record${success.length > 1 ? 's' : ''} deleted successfully`,
          { duration: 4000 }
        );
      ...
      console.error('[learners/alumni] Error deleting records:', error);
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              alumni record{learnersToDelete.length > 1 ? 's' : ''} and remove all
              associated data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
