...
//   /admin/hr previously had no page.tsx, so any director who typed
//   `/admin/hr` (or followed an outdated link) hit a 404 after auth.
//   17 subroutes already exist under /admin/hr/* — this page makes them
...
//
// Audience gating:
//   Routing into /admin/* is gated by middleware (see /admin/page.tsx — it
//   reads policy + redirects, which would never run for a non-admin). Cards
//   render permissively for any user the middleware allowed through. Each
//   destination page enforces its own role checks (super_admin / hr_head /
//   hr_officer / director_jkkn) — keeping the hub itself permissive avoids
...
const SECTIONS: Section[] = [
  {
    ...
    cards: [
      ...
      {
        href: '/admin/hr/required-documents',
        icon: ClipboardList,
  ...
  },
  {
    ...
    cards: [
      ...
      {
        href: '/admin/hr/recruitment-approvals-scope',
        icon: ShieldCheck,
  ...
  },
  {
    ...
    cards: [
      ...
      {
        href: '/admin/hr/performance-reviews',
        icon: Award,
