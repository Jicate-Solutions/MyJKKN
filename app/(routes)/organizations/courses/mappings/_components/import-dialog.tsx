...
/**
 * Import Dialog Component for Course Mappings
 *
 * Features:
...
export function ImportDialog({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/organizations/course-mappings/import', {
        method: 'POST',
        body: formData
      });
              ...
              {file ? (
                ...
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    className="hidden"
                    id="course-mapping-file-upload"
                  />
                  <label htmlFor="course-mapping-file-upload">
