...
/**
 * /hr/leave/balance — answers with a REAL HTTP 307 to /hr/leave/requests?tab=balance.
 *
 * Was a page.tsx calling `redirect('/hr/leave/requests?tab=balance')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/hr/leave/requests?tab=balance">`:
 ...
 * `<Link href="/hr/leave/balance">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/hr/leave/requests?tab=balance', request.url), 307);
}
