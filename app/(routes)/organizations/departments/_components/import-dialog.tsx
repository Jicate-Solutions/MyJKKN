...
export function ImportDialog({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(
          `Successfully imported ${data.successCount} department${data.successCount !== 1 ? 's' : ''}!`,
          {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload an Excel file to import multiple departments at once. The file must match
            the template format.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-green-700 dark:text-green-300">
                          Successfully imported {result.successCount} department
              ...
              {result.duplicateCodes && result.duplicateCodes.length > 0 && (
                <Alert variant="destructive">
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    <p className="font-medium mb-2">Duplicate Department Codes Found:</p>
