...
// =====================================================================
// /admin/hr/policies/excursion-general — institution excursion programme
// =====================================================================
// Wave 3 M6c — HR Policy Manual replacement.
// Policy key: hr.excursion_general (JSONB §32)
//
// Distinct from /admin/hr/policies/rd/excursion (hr.rd.excursion, Wave 3 M3),
...
const SCHEMA_NOTES = [
  ...
  'NOTE — this is the *general* excursion policy. R&D-incentive excursions (top N published-paper authors getting a family trip) live at /admin/hr/policies/rd/excursion under key `hr.rd.excursion`.',
];
    ...
    <PermissionGuard module="users" action="manage">
      <ContentLayout title="Excursion programme">
        ...
        <InstitutionPolicyEditor
          ...
          policyDescription="Permitted excursion types and approval flow. Separate from the R&D-incentive excursion under /admin/hr/policies/rd/excursion."
