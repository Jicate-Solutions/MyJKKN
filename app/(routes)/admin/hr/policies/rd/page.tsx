...
//   /admin/hr/policies/rd previously had no page.tsx, so any director who
//   typed `/admin/hr/policies/rd` (or followed an outdated link) hit a 404
//   after auth. 5 R&D-policy subroutes already exist under
//   /admin/hr/policies/rd/* — this page makes them discoverable from a single
...
const CARDS: ActionCardProps[] = [
  {
    href: '/admin/hr/policies/rd/excursion',
    icon: Plane,
    title: 'Excursion (R&D)',
    description:
  ...
  {
    href: '/admin/hr/policies/rd/incentive-authority',
    icon: Award,
  ...
  {
    href: '/admin/hr/policies/rd/wfh-rules',
    icon: Home,
    title: 'WFH Rules',
    description:
