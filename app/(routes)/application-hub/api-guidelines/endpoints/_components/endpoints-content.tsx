  ...
  return (
    <div className='py-4 space-y-6'>
      ...
      <Accordion type='single' collapsible className='space-y-4'>
        {/* Students Endpoints */}
        <AccordionItem value='students' className='border rounded-lg'>
          <AccordionTrigger className='px-4 hover:no-underline'>
            <div className='flex items-center gap-2'>
              <span className='font-semibold'>Students API</span>
              <Badge variant='secondary'>GET</Badge>
            </div>
          </AccordionTrigger>
          <AccordionContent className='px-4 pb-4 space-y-6'>
            <div className='space-y-4'>
              <h3 className='text-lg font-semibold'>List Students</h3>
              <CodeBlock
                language='bash'
              ...
              <h3 className='text-lg font-semibold'>Get Student by ID</h3>
              <CodeBlock
                language='bash'
