// app/api/cron/orchestration-run-ai/security/route.ts
//
// GET /api/cron/orchestration-run-ai/security
...
// "orchestration-run-ai-security" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'security');
}
