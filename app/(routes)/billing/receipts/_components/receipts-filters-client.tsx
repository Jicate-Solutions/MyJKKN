/**
 * Receipts Filters Client Component
 *
 * URL-based filtering for receipt list page.
...
export function ReceiptsFiltersClient() {
  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
        ...
        {/* Payment Mode Filter */}
        <div className='space-y-2'>
          <Label htmlFor='payment_mode' className='text-sm'>
            Payment Mode
          </Label>
          <Select
            value={searchParams.get('payment_mode') || 'all'}
            onValueChange={(value) => handleFilterChange('payment_mode', value)}
            disabled={isPending}
          >
        ...
        {/* Date From */}
        <div className='space-y-2'>
          <Label htmlFor='receipt_date_from' className='text-sm'>
            From Date
          </Label>
          <Input
            id='receipt_date_from'
            type='date'
            defaultValue={searchParams.get('receipt_date_from') || ''}
            onChange={(e) =>
              handleFilterChange('receipt_date_from', e.target.value || undefined)
            }
            disabled={isPending}
          />
        </div>
        ...
        {/* Date To */}
        <div className='space-y-2'>
          <Label htmlFor='receipt_date_to' className='text-sm'>
            To Date
          </Label>
          <Input
            id='receipt_date_to'
            type='date'
            defaultValue={searchParams.get('receipt_date_to') || ''}
            onChange={(e) =>
              handleFilterChange('receipt_date_to', e.target.value || undefined)
            }
            disabled={isPending}
          />
        </div>
        ...
        <div className='space-y-2'>
          ...
          <Select
            value={searchParams.get('sortBy') || 'receipt_date'}
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value='payment_amount'>Payment Amount</SelectItem>
