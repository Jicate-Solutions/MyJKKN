...
/**
 * /learn — answers with a REAL HTTP 307 to /learn/quests.
 *
 * Was a page.tsx calling `redirect('/learn/quests')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/learn/quests">`:
 ...
 * `<Link href="/learn">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/learn/quests', request.url), 307);
}
