...
/**
 * /hr/leave/approve — answers with a REAL HTTP 307 to /hr/leave/approvals.
 *
 * Was a page.tsx calling `redirect('/hr/leave/approvals')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/hr/leave/approvals">`:
 ...
 * `<Link href="/hr/leave/approve">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/hr/leave/approvals', request.url), 307);
}
