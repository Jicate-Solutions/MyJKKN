...
/**
 * /admission/social/admin — answers with a REAL HTTP 307 to /admission/social/admin/policies.
 *
 * Was a page.tsx calling `redirect('/admission/social/admin/policies')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/admission/social/admin/policies">`:
 ...
 * `<Link href="/admission/social/admin">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/admission/social/admin/policies', request.url), 307);
}
