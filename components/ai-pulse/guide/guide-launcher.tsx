...
import { type PersonaGuide, type GuideEvent, type GuidePersona, laneProgress } from "@/lib/ai-pulse/guide/types"; // ← adjust path
import { useGuideProgress } from "@/lib/ai-pulse/guide/use-progress"; // ← adjust path
import { GuideDrawer } from "@/components/ai-pulse/guide/guide-drawer"; // ← adjust path
