...
export default function HostelCategoriesPage() {
  ...
  return (
    <ContentLayout title='Hostel Categories'>
      <div className='space-y-6'>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Hostel Categories</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
          ...
          <CardContent className='p-6'>
            <div className='space-y-6'>
              <div className='flex items-center justify-between'>
                <div>
                  <h2 className='text-lg font-semibold'>Hostel Categories</h2>
                  <p className='text-sm text-muted-foreground'>
                    Manage hostel categories such as Boys Hostel, Girls Hostel, and Mixed Hostel.
