...
export const MISC_AI_ROUTINES: AIRoutine[] = [
  ...
  },
  {
    ...
    "configKnobs": "QUIET_CLIENT_DAYS=14 (lib/solutions/digest.ts). Recipient resolved at runtime by email mohanraj_v@jkkn.ac.in — the circulated 18f56a8d… id is a STAFF id, not a profiles.id, and hardcoding it would deliver to nobody silently. Day/time editable at /admin/ai-routines. No model, no LLM.",
