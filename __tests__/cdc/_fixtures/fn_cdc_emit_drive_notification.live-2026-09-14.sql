...
-- live catalogue (pg_get_functiondef) on 2026-09-14, renamed so it can be
...
CREATE OR REPLACE FUNCTION public.fn_ctl_live_emit(p_drive_id uuid, p_from_state text, p_to_state text, p_actor uuid)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
