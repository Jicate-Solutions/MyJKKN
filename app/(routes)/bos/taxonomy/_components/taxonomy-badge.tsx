    ...
    t === 'finks'
      ...
      : t === 'blooms'
        ...
        : t === 'jkkn_advanced'
          ? 'JKKN Advanced'
          : type;
  const title = t === 'jkkn_advanced' ? "JKKN Advanced Bloom's Taxonomy" : undefined;
  return (
    <Badge variant='outline' title={title} className={cn('capitalize font-medium', cls, className)}>
      {label}
    </Badge>
  );
}
