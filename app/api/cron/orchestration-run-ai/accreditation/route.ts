// app/api/cron/orchestration-run-ai/accreditation/route.ts
//
// GET /api/cron/orchestration-run-ai/accreditation
...
// "orchestration-run-ai-accreditation" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'accreditation');
}
