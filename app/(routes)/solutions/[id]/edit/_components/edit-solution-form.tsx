...
import { Loader2, Hammer, BookOpen, Video, AlertCircle, Users, FlaskConical, ClipboardCheck } from 'lucide-react';
...
type SolutionType = 'software' | 'training' | 'content' | 'consulting' | 'research' | 'audit';
...
const typeConfig: Record<SolutionType, { icon: React.ElementType; color: string; label: string }> = {
  ...
  consulting: { icon: Users, color: 'text-amber-600', label: 'Consulting' },
  research: { icon: FlaskConical, color: 'text-teal-600', label: 'Research' },
  audit: { icon: ClipboardCheck, color: 'text-rose-600', label: 'Audit' },
};
