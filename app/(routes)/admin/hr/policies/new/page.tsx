...
//   /admin/hr/policies/new previously had no page.tsx, so any director who
//   typed `/admin/hr/policies/new` (or followed an outdated link) hit a 404
//   after auth. 4 modern-workplace-policy subroutes already exist under
//   /admin/hr/policies/new/* — this page makes them discoverable from a
...
const CARDS: ActionCardProps[] = [
  {
    href: '/admin/hr/policies/new/data-privacy-it-acceptable-use',
    icon: ShieldCheck,
  ...
  {
    href: '/admin/hr/policies/new/genai-usage',
    icon: Sparkles,
    title: 'GenAI Usage',
    description:
  ...
  {
    href: '/admin/hr/policies/new/remote-hybrid-work',
    icon: Home,
  ...
  {
    href: '/admin/hr/policies/new/social-media-conduct',
    icon: MessageCircle,
