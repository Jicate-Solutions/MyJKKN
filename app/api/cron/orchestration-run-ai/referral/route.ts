// app/api/cron/orchestration-run-ai/referral/route.ts
//
// GET /api/cron/orchestration-run-ai/referral
...
// "orchestration-run-ai-referral" (type: 'cron', safeToManualTrigger: true).
...
export async function GET(request: NextRequest) {
  return runOrchestrationModuleCheck(request, 'referral');
}
