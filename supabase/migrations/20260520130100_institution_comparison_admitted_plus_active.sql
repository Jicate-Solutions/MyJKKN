-- 2026-05-20: Update fn_institution_comparison so 'enrolled_count' matches the
-- new workflow's "Admitted" semantics (lifecycle_status IN admitted+active),
-- aligning the Institution Comparison tab with the redefined headline KPI.
-- Also fixes a latent bug: lp.admission_year column was retired 2026-05-02;
-- swapped to lp.admission_year_id with a join to admission_years.
