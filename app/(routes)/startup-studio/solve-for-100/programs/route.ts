...
/**
 * /startup-studio/solve-for-100/programs — answers with a REAL HTTP 307 to /startup-studio/solve-for-100/admin?tab=programs.
 *
 * Was a page.tsx calling `redirect('/startup-studio/solve-for-100/admin?tab=programs')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/startup-studio/solve-for-100/admin?tab=programs">`:
 ...
 * `<Link href="/startup-studio/solve-for-100/programs">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/startup-studio/solve-for-100/admin?tab=programs', request.url), 307);
}
