...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await LifecycleDashboardService.getModuleDetail(
      {
        date_from: dateFrom,
        date_to: dateTo,
    ...
    console.error('[analytics/usage/modules] Error:', error);
    return NextResponse.json(
