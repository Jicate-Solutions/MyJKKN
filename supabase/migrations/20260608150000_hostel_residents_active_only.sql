-- Narrow the Hostel Residents surface to ACTIVE learners only.
--
-- Supersedes the active/reserved/admitted set from 20260608130000 (stakeholder
-- revised 2026-06-08): residents = hostel AND lifecycle_status = 'active'.
-- Drops reserved (79) + admitted (1) from both the Residents list AND the
-- Generate-bills surface (they share this view). Keeps the lifecycle_status
-- column added in 20260608140000. Mirrored into supabase/setup/05_views.sql.
