...
import type { ReferralReward, RewardType, RewardStatus, EducationConsultant } from '@/types/education-consultants';
...
const rewardTypeConfig: Record<RewardType, { label: string; icon: React.ElementType; color: string; bgColor: string }> = {
  ...
  fee_discount: { label: 'Fee Discount', icon: Percent, color: 'text-blue-500', bgColor: 'bg-blue-50' },
  cashback: { label: 'Cashback', icon: DollarSign, color: 'text-green-500', bgColor: 'bg-green-50' },
  cash: { label: 'Cash', icon: DollarSign, color: 'text-green-500', bgColor: 'bg-green-50' },
  credit: { label: 'Credit', icon: CreditCard, color: 'text-purple-500', bgColor: 'bg-purple-50' },
  credits: { label: 'Credits', icon: CreditCard, color: 'text-purple-500', bgColor: 'bg-purple-50' },
  ...
  scholarship: { label: 'Scholarship', icon: Gift, color: 'text-amber-500', bgColor: 'bg-amber-50' },
  gift: { label: 'Gift', icon: Gift, color: 'text-rose-500', bgColor: 'bg-rose-50' },
  points: { label: 'Points', icon: Sparkles, color: 'text-indigo-500', bgColor: 'bg-indigo-50' },
};
