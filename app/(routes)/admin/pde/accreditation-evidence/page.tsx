 ...
 *
 * /admin/pde/accreditation-evidence previously 404'd because no page.tsx
...
export default async function AdminPdeAccreditationEvidenceIndex() {
  ...
  const { data } = await supabase.rpc('fn_get_policy_text', {
    ...
    p_default: '/admin/pde/accreditation-evidence/NAAC',
    p_scope_id: null,
  });
  redirect(data ?? '/admin/pde/accreditation-evidence/NAAC');
}
