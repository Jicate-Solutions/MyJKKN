...
// =====================================================================
// /admin/hr/policies/reimbursement-workflow — paper publication reimbursement
// =====================================================================
...
const SCHEMA_NOTES = [
  ...
  'NOTE — eligibility thresholds (papers required, impact factor) live separately under `hr.rd.publication_incentives` at /admin/hr/policies/rd/publication-incentives. This policy is about *how* to claim, not *whether* you qualify.',
];
