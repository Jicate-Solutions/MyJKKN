...
// Chrome-less editor body for the approval-chain rules admin page.
// Extracted (behavior-preserving) from approval-chains/page.tsx so it can be
// embedded inside the unified Campus Living config sections without wrapping its
// own ContentLayout. Renders the same loading spinner, breadcrumb, header, rule
// cards, and edit/delete dialogs as before — only the outer ContentLayout chrome
...
export function ApprovalChainsSection() {
