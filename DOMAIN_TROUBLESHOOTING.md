...
The website https://jkkn.ai/ works in some browsers but shows `ERR_FAILED` error in certain Chrome browsers.
...
- Both domains (jkkn.ai and m.jkkn.ac.in) are configured
...
openssl s_client -connect jkkn.ai:443 -servername jkkn.ai
```
...
curl -I https://jkkn.ai/

# Verbose output for debugging
curl -v https://jkkn.ai/
```
...
Only the root URL (https://jkkn.ai/) shows ERR_FAILED on refresh, while all other pages work fine.
