    ...
    <ContentLayout title="Preview Case (as student)">
      <PageBreadcrumb
        items={[
          ...
          { label: c.title.slice(0, 40) + (c.title.length > 40 ? '…' : ''), href: `/faculty/pde/cases/${c.id}/edit` },
          { label: 'Preview' },
        ]}
      />
      ...
      <div className="space-y-4 mt-4">
        ...
        <div className="flex justify-between items-center">
          <Button variant="outline" size="sm" asChild>
            <Link href={`/faculty/pde/cases/${c.id}/edit`}>
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            attempt counter, OSCE scoring) lives in <code>/learn/pde/cases/[caseSlug]</code> and is
