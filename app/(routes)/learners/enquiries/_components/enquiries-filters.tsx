...
import { EnquiriesSearchParams } from './data-table-schema';
  ...
  useEffect(() => {
    const fetchInstitutions = async () => {
      try {
        ...
        console.error('[learners/enquiries] Error fetching institutions:', error);
        setInstitutions([]);
      }
    };
  ...
  useEffect(() => {
    const fetchDegrees = async () => {
      ...
      try {
        ...
        console.error('[learners/enquiries] Error fetching degrees:', error);
        setDegrees([]);
      } finally {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      ...
      try {
        ...
        console.error('[learners/enquiries] Error fetching departments:', error);
        setDepartments([]);
      } finally {
  ...
  useEffect(() => {
    const fetchPrograms = async () => {
      ...
      try {
        ...
        console.error('[learners/enquiries] Error fetching programs:', error);
        setPrograms([]);
      } finally {
  ...
  useEffect(() => {
    const fetchSemesters = async () => {
      ...
      try {
        ...
        console.error('[learners/enquiries] Error fetching semesters:', error);
        setSemesters([]);
      } finally {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      ...
      try {
        ...
        console.error('[learners/enquiries] Error fetching sections:', error);
        setSections([]);
      } finally {
  ...
  useEffect(() => {
    const fetchAcademicYears = async () => {
      ...
      try {
        ...
        console.error('[learners/enquiries] Error fetching academic years:', error);
        setAcademicYears([]);
      } finally {
