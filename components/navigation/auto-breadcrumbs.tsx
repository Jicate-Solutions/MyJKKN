...
export function AutoBreadcrumbs({ className }: AutoBreadcrumbsProps) {
  ...
  // Also skip trails that are only "Home › <this page>". The page title is
  // already in the header immediately above the trail, so a two-crumb line
  // just repeats it and costs a row of screen height for nothing. This is
  // what made the dashboard read "Dashboard" twice, one line apart.
