...
//
// ACTIVATION: the schedule row ships enabled=false AND managed=false because
// the dispatcher resolves routines via the code registry (a shared
// collision-zone file not touched by this PR). Follow-up: add the
// 'attendance-intervention-measure' registry entry, then flip enabled+managed
// on /admin/ai-routines — no deploy needed for the flip.
//
