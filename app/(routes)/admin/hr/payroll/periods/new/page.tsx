...
/**
 * /admin/hr/payroll/periods/new — period create flow (T4.3 PR 3).
 *
 ...
 *      to /admin/hr/payroll/periods/{id} where HR Officer presses
      ...
      <ContentLayout title="Create Payroll Period">
        <PageBreadcrumb
          items={[
            ...
            { label: 'HR' },
            { label: 'Payroll' },
            { label: 'Periods', href: '/admin/hr/payroll/periods' },
            { label: 'New' },
          ]}
        />
...
function NewPayrollPeriodContent() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push(`/admin/hr/payroll/periods/${result.id}`);
    } catch {
  ...
  return (
    <div className="space-y-4 max-w-2xl">
      <Button asChild variant="ghost" size="sm" className="-ml-2">
        <Link href="/admin/hr/payroll/periods">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <Button variant="outline" asChild>
              <Link href="/admin/hr/payroll/periods">Cancel</Link>
            </Button>
