...
export const GUIDE_PERSONAS: readonly GuidePersona[] = [
  // Order = default priority: most-specific first. A student/parent payer is
  // pinned to "payer" by the page regardless of any stray staff key. The
  // payer lane has NO `requires` (universal instructional baseline, like
  // campus-living's resident lane); finance-officer + finance-admin are
  // permission-gated.
  "finance-admin",
  "finance-officer",
  "payer",
