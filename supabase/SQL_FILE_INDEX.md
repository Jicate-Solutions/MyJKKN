...
- Config rows (platform_policies): `cdc_placement_loop.master_enabled=false` (DARK gate — route + fn both check), `cdc_placement_loop.min_cohort_size=10` (cohorts below it skipped as noise). Both flagged Director-reviewable.
