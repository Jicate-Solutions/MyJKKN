...
/**
 * Import Dialog Component for Degrees
 *
 * Features:
...
export function ImportDialog({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/organizations/degrees/import', {
        method: 'POST',
        body: formData
      });
      ...
      if (data.success) {
        toast.success(
          `Successfully imported ${data.successCount} ${adapt('degree')}${data.successCount !== 1 ? 's' : ''}!`,
          {
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Import {adapt('Degrees')}
          </DialogTitle>
          <DialogDescription>
            Upload an Excel file to import multiple {adapt('degrees')} at once. The file must match
            the template format.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-green-700 dark:text-green-300">
                          Successfully imported {result.successCount} {adapt('degree')}
              ...
              {result.duplicateCodes && result.duplicateCodes.length > 0 && (
                <Alert variant="destructive">
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    <p className="font-medium mb-2">Duplicate {adapt('Degree')} IDs Found:</p>
