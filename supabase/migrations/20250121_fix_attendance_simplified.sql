-- Simplified fix for get_attendance_report_list function
-- Removing complex staff JOINs that cause duplicates and errors
...
BEGIN
    ...
    -- Simplified base query without complex staff JOINs
    base_query := '
        SELECT DISTINCT
            sa.id::TEXT as id,
            sa.attendance_date,
