// =====================================================================
// /admin/hr/policies — Wave 3 policy editor index
// =====================================================================
...
const POLICY_EDITORS: ReadonlyArray<PolicyEditorEntry> = [
  ...
  {
    href: '/admin/hr/policies/institution-meta',
  ...
  {
    href: '/admin/hr/policies/facilities',
    title: 'Facilities',
  ...
  {
    href: '/admin/hr/policies/working-schedule',
  ...
  {
    href: '/admin/hr/policies/welfare',
  ...
  {
    href: '/admin/hr/policies/roles-responsibilities',
  ...
  {
    href: '/admin/hr/policies/academic-scope',
  ...
  {
    href: '/admin/hr/policies/teaching-artifacts',
  ...
  {
    href: '/admin/hr/policies/pay-scales',
    title: 'Pay scales',
  ...
  {
    href: '/admin/hr/policies/allowances-and-increments',
  ...
  {
    href: '/admin/hr/policies/motivation-fund',
