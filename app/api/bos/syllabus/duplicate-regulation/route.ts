...
/**
 * POST /api/bos/syllabus/duplicate-regulation
 *
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (fetchError) {
      console.error('[POST /api/bos/syllabus/duplicate-regulation] Fetch error:', fetchError);
      return NextResponse.json(
    ...
    if (insertError) {
      console.error('[POST /api/bos/syllabus/duplicate-regulation] Insert error:', insertError);
      return NextResponse.json(
    ...
    console.error('[POST /api/bos/syllabus/duplicate-regulation] Error:', error);
    return NextResponse.json(
