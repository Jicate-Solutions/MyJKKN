...
//   /admin/hr/payroll previously had no page.tsx, so any director who typed
//   the URL (or followed an outdated link) hit a 404. Same 404 class as
//   PR #1008 which fixed the parent /admin/hr. Two subroutes already exist
//   under /admin/hr/payroll/* — this page makes them discoverable from one
//   landing instead of requiring users to know the exact subpath.
//
// What's here:
//   Two ActionCards:
//   - "Payroll Periods"  → /admin/hr/payroll/periods
//   - "Payroll Preview"  → /admin/hr/payroll/preview
//
// Audience gating:
