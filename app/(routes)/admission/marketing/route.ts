...
/**
 * /admission/marketing — answers with a REAL HTTP 307 to /admission/marketing/campaigns.
 *
 * Was a page.tsx calling `redirect('/admission/marketing/campaigns')`. Because
 ...
 * document carrying `<meta http-equiv="refresh" content="1;url=/admission/marketing/campaigns">`:
 ...
 * `<Link href="/admission/marketing">` navigation keeps working.
 *
...
export function GET(request: NextRequest) {
  return NextResponse.redirect(new URL('/admission/marketing/campaigns', request.url), 307);
}
